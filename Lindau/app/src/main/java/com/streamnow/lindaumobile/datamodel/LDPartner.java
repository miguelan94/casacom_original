...
public class LDPartner
{
    ...
    public LDPartner(JSONObject o)
    {
        ...
        try
        {
            ...
            this.colorService = ld.colorFromRGBAString("rgba(29,153,29,1)");
            ...
            this.fontColorSmartphone = ld.colorFromRGBAString("rgba(255,255,255,1)");
            if(!o.isNull("logo")) this.logo = o.getString("logo");
            this.backgroundColorSmartphone = ld.colorFromRGBAString("rgba(255,255,255,1)");
